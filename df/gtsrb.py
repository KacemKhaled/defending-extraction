# Source https://pytorch.org/vision/main/_modules/torchvision/datasets/gtsrb.html
...
class GTSRB(VisionDataset):
    ...
    _md5s = ("c7e4e6327067d32654124b0fe9e82185",
             # "513f3c79a4c5141765e10e952eaa2478",
             "f33fd80ac59bff73c82d25ab499e03a3")
    ...
    def __init__(
        ...
        self._base_folder = os.path.join(self.root, self.base_folder)
        # self._target_folder = os.path.join(self._base_folder, "Training" if self.train else "Final_Test/Images")
        self._target_folder = os.path.join(self._base_folder, "Final_Training/Images" if self.train else "Final_Test/Images")
        ...
        if train:
            ...
            with open(os.path.join(self._base_folder, self._gt_csv)) as csv_file:
                ...
                self.data = [path for path, _ in samples]
